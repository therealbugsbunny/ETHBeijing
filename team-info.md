...
# 51 Parami in Scroll
* 简介：
EIP-5489 实现 NFT的全新效用和商业化模式
 *NFT 的全新用途
2022 年 11 月 29 日，Parami Protocol 开发并提交的 EIP-5489进入成为ERC标准前的终审阶段。此标准通过允许将超链接嵌入 NFT 的元数据卡槽来扩展 ERC-721 的新功能，这样 NFT 的受众可以点击并并跳转到的任何指定的URI 落地页。
*NFT 的新收入
正如超链接在 Web1 时代对互联网所做的突破一样，超链接使数字广告成为互联网商业化的支柱。迄今为止，数字广告仍然是互联网最大的营收手段， 2021 年数字广告为互联网行业创造了 5210 亿美元的营收。
